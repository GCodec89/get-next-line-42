...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/16 21:33:16 by gonolive          #+#    #+#             */
/*   Updated: 2024/05/16 21:34:21 by gonolive         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	txt[fd] = get_full_line(fd, txt[fd]);
	if (!txt[fd])
	{
		return (NULL);
	}
	line = trim_line(txt[fd]);
	txt[fd] = what_is_left(txt[fd]);
	return (line);
}
